        ...
        <div class="box-header with-border">
          ...
          echo'
            ...
            <table id="swdatatable" class="table table-bordered">
              ...
              <tbody>';
              $query="SELECT building_id,name,address,koordinat_kantor,radius FROM building order by building_id  DESC";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
            ...
            <input type="text" class="form-control" name="koordinat_kantor" required>
        </div>
		
		<div class="form-group">
            <label>Radius</label>
            <input type="text" class="form-control" name="radius" required>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
		 ...
		 <div class="form-group">
            <label>Koordinat Lokasi</label>
            <input type="text" class="form-control" id="txtkoordinat" name="koordinat" required>
        </div>
		<div class="form-group">
            <label>Radius</label>
            <input type="text" class="form-control" id="txtradius" name="radius" required>
        </div>
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-check"></i> Simpan</button>
