...
function viewdt() {
	...
	$.ajax({
        url: 'sw-mod/report/proses.php?action=reporttgl&kd_bidang='+kd_bidang+'&tanggal='+tanggal+'&status_peg='+status_peg+'',
        type: 'POST',
		beforeSend: function () {
			$('#loading1').show();	
		},
...
function exceldt(){
	...
	var tanggal = $('#tanggal').val();
	var status_peg = $('#status_peg').val();	
	window.open('sw-mod/report/proses.php?action=excelreporttgl&kd_bidang='+kd_bidang+'&tanggal='+tanggal+'&status_peg='+status_peg+'');
}
...
function viewdtbln() {
	...
	$.ajax({
        url: 'sw-mod/report/proses.php?action=reportbln&kd_bidang='+kd_bidang+'&tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir+'&status_peg='+status_peg+'',
        type: 'POST',
		beforeSend: function () {
			$('#loading2').show();	
		},
...
function exceldtbln(){
	...
	var tgl_akhir = $('#tgl_akhir').val();	
	var status_peg = $('#statuspeg').val();	
	window.open('sw-mod/report/proses.php?action=excelreportbln&kd_bidang='+kd_bidang+'&tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir+'&status_peg='+status_peg+'');
}
