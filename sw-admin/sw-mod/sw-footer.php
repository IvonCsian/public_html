...
echo'
 ...
 <div class="pull-right hidden-xs" style="display: none;>
    Redeveloped by <a href="gresscode.com" rel="dofollow" target="_blank">tokoweb.online</a> - <a href="gresscode.com" rel="dofollow" target="_blank">Towebline</a>
    </div>
...
<script src="./sw-assets/js/jquery.form.js"></script>
<script src="./sw-assets/js/validasi/messages_id.js"></script>';

if($mod =='shift' OR $mod=='shiftpegawai' OR $mod=='office' OR $mod=='report' OR $mod=='job' OR $mod=='rekap'){echo'
...
<script src="./sw-assets/plugins/select2/dist/js/select2.min.js"></script>';
}

if($mod=='karyawan' OR $mod =='jabatan' OR $mod =='kerja' OR $mod=='shift' OR $mod=='lokasi' OR $mod=='user' OR $mod=='absensi' OR $mod=='cuty' OR $mod=='sppd' OR $mod=='shiftpegawai' OR $mod=='bidang' OR $mod=='office' OR $mod=='report' OR $mod=='rekap' OR $mod=='statuspegawai' OR $mod=='izin' OR $mod=='job'){
echo'
