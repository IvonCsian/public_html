<div class="page-content-wrapper">
	...
	<div class="cart-wrapper-area py-3">
		<?php 
			$DataOrder = $this->tracking_model->cekPesanan();
			if($DataOrder > 0){ 
				$DataResult = $this->tracking_model->jmPesanan();
				foreach ($DataResult as $key => $value) {
					...
					<div class='card-body d-flex align-items-center justify-content-between'>
						...
						<button class='btn btn-primary' onclick=detailtrack('$no_bukti_order')>Lacak</button>
					</div>
					</div><p></p>";
				}
			}
...
<script type="text/javascript">
	function detailtrack(no_bukti_order){
