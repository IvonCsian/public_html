                    ...
                    <form id="update-profile">
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" value="'.$row_user['employees_code'].'" readonly>
                                <i class="clear-input">
						...
						<div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="email4">Alamat</label>
                                <input type="text" class="form-control" id="address" name="address" value="'.$row_user['address'].'">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
						...
						<div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="email4">No.Handphone</label>
                                <input type="text" class="form-control" id="phone" name="phone" value="'.$row_user['phone'].'">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                    ...
                    <form id="update-password">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="email" class="form-control" name="employees_email_code" value="'.$row_user['employees_code'].'" style="background:#eeeeee" readonly>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
...
function myFunction() {
  var x = document.getElementById("employees_password");
  if (x.type === "password") {
    x.type = "text";
  } else {
    x.type = "password";
