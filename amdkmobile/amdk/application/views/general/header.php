...
<html lang="en">
  <head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url().'libraries/dist/img/icons/icon-72x72.png'?>">
    <!-- Apple Touch Icon-->
    ...
    <link rel="stylesheet" href="<?php echo base_url().'libraries/dist/css/default/lineicons.min.css'?>">
    <!-- Stylesheet-->
  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Logo Wrapper-->
        <div class="logo-wrapper"><a href="home.html"><img src="<?php echo base_url().'libraries/dist/img/core-img/logo-small.png'?>" alt=""></a></div>
        <!-- Page Title-->
