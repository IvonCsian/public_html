            ...
            <div class="row g-3">
              ...
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="<?php echo base_url(); ?>index.php/order/orderbarang"><i class="lni lni-shopping-basket"></i><span>Order</span></a></div>
                </div>
              </div>
              <!-- Single Catagory Card-->
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="<?php echo base_url(); ?>index.php/tracking/vtracking"><i class="lni lni-delivery"></i><span>Tracking</span></a></div>
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="<?php echo base_url(); ?>index.php/transaksi/vtransaksi"><i class="lni lni-book"></i><span>Transaksi</span></a></div>
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="<?php echo base_url(); ?>index.php/history/vhistory"><i class="lni lni-layers"></i><span>Riwayat</span></a></div>
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="<?php echo base_url(); ?>index.php/stok/stokbarang"><i class="lni lni-user"></i><span>Profile</span></a></div>
                </div>
              </div>
              <!-- Single Catagory Card-->
              <div class="col-4">
                <div class="card catagory-card">
                  <div class="card-body"><a class="text-danger" href="catagory.html"><i class="lni lni-files"></i><span>Report</span></a></div>
                </div>
              </div>
      ...
      <div class="featured-products-wrapper py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between">
            <h6>Products</h6><a class="btn btn-warning btn-sm" href="featured-products.html">View All</a>
          </div>
          <div class="row g-3">
		    <?php 
