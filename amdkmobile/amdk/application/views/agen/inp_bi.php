<div class="page-content-wrapper">
      ...
      <div class="top-products-area py-3">
        <div class="container">
          ...
          <div class="row g-3">
			...
			<?php 
				$DataResult = $this->penerimaan_model->dataBarangAgen();
				...
				<div class="col-12 col-md-6">
					<div class="card weekly-product-card">
						...
						<div class="product-description"><a class="product-title d-block" href="single-product.html"><?php echo $nm_barang?></a>
							...
							<?php echo "<button class='btn btn-success btn-sm' onclick=barangmasuk('$value->kd_barang')><i class='me-1 lni lni-plus'></i>Terima</button>" ?>
						</div>
						</div>
					</div>
				</div>
	...
	function checkout() {
		window.location.href='<?php echo base_url(); ?>index.php/penerimaan/inputbidtl';
	}
	</script>